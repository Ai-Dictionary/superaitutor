...
class ExamInterface {
    ...
    setPapersUrl() {
        for (let i = 0; i < paper.length; i++) {
            this.root.innerHTML += `<script src="./database/${paper[i]}.min.js" crossorigin="anonymous"></script>`;
        }
    }
...
function user() {
    const interface = new ExamInterface();
    interface.user();   // sets up listeners and exam data
}