...
class ExamManger {
    ...
    c_task(index) {
        let text = document.querySelectorAll(".h_task_holder .h_task")[index].querySelector(".body").textContent;
    ...
    check_host(){
        this.c_task(1);
        if(window.location.host == 'superaitutor.vercel.app' || window.location.host == 'superaitutor.com'){
            this.h_task(1, true);
        }else{
            this.h_task(1, false);
        }
